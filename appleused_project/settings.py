...
#
# # SECRET_KEY = 'd=2=#+%u1b#l2jm0k9#=t=0+4^bpbyi1datc%=1_)(1p&rs&@c'
#
...
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # my_project for testing in console panel
